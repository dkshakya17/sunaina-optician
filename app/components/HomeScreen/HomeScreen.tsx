      ...
      <div className="relative">
        <div className="flex sm:flex-row flex-col bg-zinc-900">
          <div className="basis-1/2 text-center sm:text-left relative">
            ...
            >
              <h1 className="text-2xl sm:text-[80px] leading-none animate-fade-in">
                SUN GLASSES,
                <br />
                CONTACT LENS
                <br /> & MORE
              ...
              <h3 className="text-base sm:text-2xl py-6">
                A NEW ALBUM BY{' '}
                <span className="text-purple-500">Sunaina Opticians</span>
              </h3>
        ...
        <div className="flex gap-2 sm:gap-14 px-14 flex-col sm:flex-row">
          <div className="text-custom-1 text-center sm:text-left pt-10 sm:py-20 basis-1/2">
            ...
            <p className="text-lg my-10 text-black">
              ...
              to the 19th century. Quality products, precision in dispensing and
              service is our main focus. Visit us to understand our processes
              and the care that goes into dispensing each item. Every eye piece
              in our store is important and so is every customer. A heritage,
              luxury brand, with 3 boutique stores located at the heart of
              Bangalore city.
            </p>
            <a
              href="/shop"
